...
calling_convention:
    ...
    mov rax, QWORD [rsp + 2 * 8] ; get rcx
    mov rbx, QWORD [rsp + 3 * 8] ; get rdx
    add rax, rbx
    mov rbx, QWORD [rsp + 4 * 8] ; get r8
    add rax, rbx
    mov rbx, QWORD [rsp + 5 * 8] ; get r9
    add rax, rbx
    mov rbx, QWORD [rsp + 6 * 8] ; get stack0
    add rax, rbx
    mov rbx, QWORD [rsp + 7 * 8] ; get stack1
    add rax, rbx
    add rsp, 8
    ret
    ; Default return
